#Script Name: colab_time_series_oficina
#Author: coLAB
...
timeseries_anticomunismo$date_value <- as.Date(timeseries_anticomunismo$date_value, 
                                               "%d/%m/%y")

#Plotar série temporal
ts.plot(timeseries_anticomunismo)

#Plotar série temporal Caso 1
ts.plot(timeseries_anticomunismo$date_unique, ylab = "Freq",
...
legend("topright", legend = c("mensagens anticomunistas"),
       lty = 1:2, cex = 0.5)
